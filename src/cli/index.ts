import { cssConfig, cssConfigStr } from './../configs/cssConfig';
import { prettierConfig, prettierConfigStr } from './../configs/prettier';
import { reactConfig, reactConfigStr } from './../configs/reactConfig';
import { tsConfig, tsConfigStr } from './../configs/tsConfig';
import { nextConfig, nextConfigStr } from './../configs/nextConfig';
import { jsConfig, jsConfigStr } from './../configs/jsConfig';
...
export default defineConfig(config);`
  ...
  try {
    ...
    console.error("❌ installed failed, do it manually:", dependencies.join(" "));
  }
}
